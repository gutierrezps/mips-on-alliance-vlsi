...
char OpCode[7], Funct[7], buffer[9], Instr[32];
...
int main() {
	...
	if( !arq ) {
		fprintf(stderr, "\nCouldn't open 'instructions_control' file.\n");
		return 1;
	}
	
	
	DEF_GENPAT("control_genpat");
